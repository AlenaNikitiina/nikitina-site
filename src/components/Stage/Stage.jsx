      ...
      <div className='stage__content'>
        ...
        <ul className='stage__list'>
          <li className='stage__item'>
            ...
            <p className='stage__paragraph'>Я вас попрошу заполнить короткий бриф с вопросами. Это поможет вам более четко определить, что вы хотите получить в результате, и облегчит мне задачу построения диалога. Чтобы убедиться в реальности человека я предлагаю созвон в зуме. </p>
          </li>
          <li className='stage__item'>
          ...
          <li className='stage__item'>
            ...
            <p className='stage__paragraph'>После приступаю к верстке версии для мобильного телефона и промежуточных.</p>
          </li>
          <li className='stage__item'>
            <h2 className='stage__subtitle'>(4)&nbsp;Внесение правок</h2>
            <p className='stage__paragraph'>Если у вас нет доменного имени, то я могу его зарегистрировать и показать вам уже рабочую страничку в интеренете. После просмотра вы сможете изменить порядок расположения блоков, их цвет или текст.</p>
          </li>
          <li className='stage__item'>
